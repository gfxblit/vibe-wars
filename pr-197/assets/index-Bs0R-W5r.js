	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}wi.BlurDirectionX=new de(1,0);wi.BlurDirectionY=new de(0,1);const Jm={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
