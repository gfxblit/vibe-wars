...
describe('TieFighter', () => {
  ...
  test('update should move TieFighter ahead of the player', () => {
    tieFighter.update(0, playerPosition, playerQuaternion, GameConfig.player.baseForwardSpeed, false);
  ...
  test('update should oscillate horizontally', () => {
    ...
    tieFighter.update(0.5, playerPosition, playerQuaternion, GameConfig.player.baseForwardSpeed, false);
  ...
  test('update() should scatter pieces when exploded', () => {
    ...
    // Update a few times
    tieFighter.update(0.1, playerPosition, playerQuaternion, GameConfig.player.baseForwardSpeed, false);
  ...
  test('smart AI should spawn behind the player and overtake', () => {
    ...
    smartTieFighter.update(0.01, playerPos, playerQuat, GameConfig.player.baseForwardSpeed, false);
    ...
    smartTieFighter.update(1, playerPos, playerQuat, GameConfig.player.baseForwardSpeed, false);
