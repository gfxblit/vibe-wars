...
export interface FireballDebugContext {
  surfaceFireballSize?: number;
  surfaceFireballSpeed?: number;
}
...
export interface Targetable {
  ...
  getFireballSize?(context?: FireballDebugContext): number;
  getFireballSpeed?(context?: FireballDebugContext): number;
}
